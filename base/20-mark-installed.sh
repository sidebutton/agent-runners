...
log ""
log "NEXT (operator):"
log "  1. If secrets were not auto-populated, fill in ${ENV_FILE}: ANTHROPIC_API_KEY, GH_TOKEN, GIT_USER_* (Jira is portal-delivered: api_key env or per-session Forge vend — do not hand-fill JIRA_*)"
